...
import { BusinessDetailUserRequestModalWrapper, ImgWrapper } from '../Business_UserManagerPageStyled'

const { TabPane } = Tabs


const BusinessDetailUserRequestModal = props => {
  const { visible, onClose } = props

  return (
    <BusinessDetailUserRequestModalWrapper>
      <Modal
        width={'90%'}
        style={{ top: '50px' }}
        maskClosable={false}
        ...
        <Descriptions
          ...
          <Descriptions.Item label={'Nội dung thay đổi'} span={2}>
            Họ tên, phòng ban, Số điện thoại, Chức năng sử dụng1
          </Descriptions.Item>
...
BusinessDetailUserRequestModal.propTypes = {
  visible: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
}

export default BusinessDetailUserRequestModal